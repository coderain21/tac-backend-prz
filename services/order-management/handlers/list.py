...
def list_orders(event, context):
    ...
    try:
        ...
        query = {"seller_email": seller_data_of_auction["seller_email"], "email_address": email_address, **search_criteria}
        ...
        total_orders = orders_collection.count_documents({"seller_email": seller_data_of_auction["seller_email"], "email_address": email_address})
