...
LAMBDA_ALARM_MAP = {
    "p1-IndyAuction-dev-Process Cart Logs Error Alarm": "auctions-dev-process-cart",
    "p1-IndyAuction-dev-Save-To-Cache-Logs-Error-Alarm": "auctions-dev-save-to-cache",
    "p1-IndyAuction-dev-Batch-Lots-Publish-Error-Alarm": "auctions-dev-batchLotsPublish",
    "p1-IndyAuction-dev-Batch-Lots-Update-Error-Alarm": "auctions-dev-batchLotsUpdate"
}
...
def get_lambda_name(api_service, api_path=None, method=None, stage="dev"):
    """
    Supports both:
      get_lambda_name(service, '/path', stage='dev')
      get_lambda_name(service, '/path', method='GET', stage='dev')
    """
    ...
    try:
        for record in event['Records']:
            ...
            if alarm_name in LAMBDA_ALARM_MAP:
                ...
                lambda_name = get_lambda_name(service, resource, method=None, stage=stage)
                print(lambda_name,"lambda_namelambda_namelambda_namelambda_name")
                route = resource
            ...
            publish_to_sns(lambda_name, route, log_link)
