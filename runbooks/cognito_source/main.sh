...
aws s3 sync . s3://indyauction-runbooks/scripts/ --exclude "*" --include "buyer_user_data.json"
...
aws s3 sync . s3://indyauction-runbooks/scripts/ --exclude "*" --include "seller_user_data.json"