...
module.exports.createTemplate = async (userData) => {
    try {
        ...
        const templates = [
            {
                name: `${userData.seller_id}-OTP-VALIDATION`, code: fetchMandrillTemplate('buyer-default-otp-template'), subject: 'OTP Verification for your account', from_email: 'no-reply@indy.auction',
            },
            {
                name: `${userData.seller_id}-PADDLE-GENERATION`, code: fetchMandrillTemplate('buyer-default-paddle-template'), subject: 'Indy.auction-Your Paddle Number Awaits: Registration Successful', from_email: 'no-reply@indy.auction',
            },
            {
                name: `${userData.seller_id}-CONGRATULATION-EMAIL`, code: fetchMandrillTemplate('default-congratulations-email'), from_email: 'no-reply@indy.auction',
            },
            {
            ...
            {
                name: `${userData.seller_id}-WINNING-EMAIL`, code: fetchMandrillTemplate('bid-notification'), from_email: 'no-reply@indy.auction',
            },
            {
                name: `${userData.seller_id}-OUTBID-EMAIL`, code: fetchMandrillTemplate('outbid-notification'), from_email: 'no-reply@indy.auction',
            },
        ]
