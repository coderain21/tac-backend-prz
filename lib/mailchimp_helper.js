...
module.exports.sendTransactionalEmail = async (getLotHistoryDetails, currentLotDetails, auctionDetails, currentBidDetails, buyerInformation, templateName) => {
    try {
        ...
        // Format bid amount (assuming formatCurrency function exists)
        const bidAmount = currentBidDetails.bid_amount // You may want to format this with currency

        // Get auction end time (assuming getDateTime function exists)
        ...
        // Build URLs (you'll need to adjust these based on your domain structure)
        ...
        const send_message = {
            ...
            merge_vars: [{
                ...
                vars: [
                    ...
                    { name: 'bid_amount', content: bidAmount },
