    ...
    try {
        const send_message = {
            ...
            global_merge_vars: [
                ...
                { name: 'winning_lot', content: templateData.winning_lots }, // This should be passed correctly
                { name: 'winning_lot_count', content: templateData.winning_lot_count.toString() },
                { name: 'not_winning_lot', content: templateData.not_winning_lots },
                ...
                { name: 'total_amount', content: templateData.totalBidAmount },
                { name: 'checkout_url', content: templateData.checkoutURL },

            ],
        }

        const emailTemplateName = 'congratulations_email_test'
