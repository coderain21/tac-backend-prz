...
module.exports.update = async (Users, user_id, update_information) => {
    try {
        console.log('update', user_id, update_information)
...
module.exports.getAuction = async (document) => {
    try {
        ...
        const collection = database.collection('dev-auctions')
        const query = {
...
module.exports.lotToCart = async (lotInformation, auctionData) => {
    try {
        ...
        console.log('gettt', getBuyerData, auctionData)
        const cartSchema = {
...
//         const database = 'indyauction-develop'// Access the database
//         const collection = 'dev-bid-informations' // Replace with your collection name
...
module.exports.getAuctionsLots = async (document, timestamp) => {
    try {
        console.log('document', document, timestamp)
        const connectionData = await this.connect()
        const database = connectionData.connection.db
        const collection = database.collection('dev-lots')
