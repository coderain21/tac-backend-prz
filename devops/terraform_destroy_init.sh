...
terraform -chdir=devops/redis init && terraform -chdir=devops/redis destroy -auto-approve & terraform -chdir=devops/mongodb init && terraform -chdir=devops/mongodb destroy -auto-approve
terraform -chdir=devops/kms init && terraform -chdir=devops/kms destroy -auto-approve & terraform -chdir=devops/api_gateway init && terraform -chdir=devops/api_gateway destroy -auto-approve
