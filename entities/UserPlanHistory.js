...
const HistorySchema = new Schema({
    ...
    previous_plan: { type: String, trim: true },
    current_plan: { type: String, trim: true },
    updated_plan_type: { type: String, trim: true },
    created_at: { type: Date, default: Date.now },
    updated_at: { type: Date, default: Date.now },
})

HistorySchema.plugin(mongoosePaginate)
const UserPlanHistory = mongoose.model(`${stage}-users-plan-history`, HistorySchema, `${stage}-users-plan-history`)
